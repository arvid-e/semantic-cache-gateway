...
> adds Prometheus/Grafana to compose — see `.kiro/steering/implementation-guide.md`.
...
- [ ] 1.1 Author the telemetry migration
  ...
  - _File: migrations/{timestamp}_request_telemetry.sql_
  - _Requirements: 1.1_
- [ ] 1.2 (P) Implement the telemetry config segment and shared types
  ...
  - _File: src/modules/telemetry/config.ts, src/modules/telemetry/types.ts_
  - _Requirements: 5.2_
...
- [ ] 1.3 (P) Implement the static pricing table
  ...
  - _File: src/modules/telemetry/pricing.ts_
...
- [ ] 2.1 (P) Implement the cost estimator
  ...
  - _File: src/modules/telemetry/cost-estimator.ts_
...
- [ ] 2.2 (P) Implement the Prometheus metrics registry and endpoint
  ...
  - _File: src/modules/telemetry/metrics.ts_
...
- [ ] 2.3 (P) Implement the telemetry repository
  ...
  - _File: src/modules/telemetry/telemetry-repository.ts_
...
- [ ] 2.4 Implement the non-blocking telemetry sink
  ...
  - _File: src/modules/telemetry/telemetry-sink.ts_
...
- [ ] 3.1 Implement the recorder and register the telemetry plugin
  ...
  - _File: src/modules/telemetry/recorder.ts, src/modules/telemetry/index.ts, src/app.ts_
...
- [ ] 3.2 (P) Provision the observability stack as code
  ...
  - _File: prometheus/prometheus.yml, grafana/provisioning/, grafana/dashboards/, docker-compose.yml_
